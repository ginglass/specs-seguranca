...
### 1.3 Criação de uma nova declaração de software  {#CriacaoSSA}
...
### 2.2 Como se comunicar com o Authorizarion Server do Diretório  {#ASDir}
...
### 4.3.1.1 Solicitação de reivindicações específicas  {#SolicitacaoReivind}
